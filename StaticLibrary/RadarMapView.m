...
- (void)drawPart {
    ...
    for (int j = 0; j<r; j++) {
        ...
        CGContextSetFillColorWithColor(context, [UIColor colorWithRed:94/255.0 green:116/255.0 blue:255/255.0 alpha:0.2].CGColor);
        ...
        CGContextDrawPath(context, kCGPathFillStroke);//kCGPathFillStroke绘制模式
    }
    //    CGContextStrokePath(context);
